resource "kubernetes_config_map" "configuration_config" {
  ...
  data = {
    NODE_ENV                                      = var.config_NODE_ENV
    SERVER_PORT                                   = var.config_SERVER_PORT
    ENABLE_INTROSPECTION                          = var.config_ENABLE_INTROSPECTION
    ENABLE_PLAYGROUND                             = var.config_ENABLE_PLAYGROUND
    REACT_APP_OTP_VALIDITY                        = var.config_REACT_APP_OTP_VALIDITY
    SEND_EMAIL_FROM                               = var.config_SEND_EMAIL_FROM
    SEND_EMAIL_FROM_NAME                          = var.config_SEND_EMAIL_FROM_NAME
    SEND_EMAIL_URL                                = var.config_SEND_EMAIL_URL
    NEO4J_POOL_SIZE                               = var.config_NEO4J_POOL_SIZE
    NEO4J_CONNECTION_ACQUISITION_TIMEOUT_MS       = var.config_NEO4J_CONNECTION_ACQUISITION_TIMEOUT_MS
    NEO4J_MAX_CONNECTION_LIFETIME                 = var.config_NEO4J_MAX_CONNECTION_LIFETIME
    NEO4J_CONNECTION_TIMEOUT                      = var.config_NEO4J_CONNECTION_TIMEOUT
    RESET_ADMIN_USER                              = var.config_RESET_ADMIN_USER
    PRIM_ADMIN_EMAIL                              = var.config_PRIM_ADMIN_EMAIL
    NEO4J_URL_TEST                                = var.config_NEO4J_URL_TEST
    PRIM_CONFIG_NEO4J_DB_TEST                     = var.config_PRIM_CONFIG_NEO4J_DB_TEST
    PRIM_SERVER_HTTP_CORS_ORIGIN                  = var.config_PRIM_SERVER_HTTP_CORS_ORIGIN
    PRIM_SERVER_HTTP_CORS_DEFAULT_ORIGIN          = var.config_PRIM_SERVER_HTTP_CORS_DEFAULT_ORIGIN
    DB_TYPE                                       = var.config_DB_TYPE
    DB_VERSION                                    = var.config_DB_VERSION
    DB_HOST                                       = var.config_DB_HOST
    DB_NAME                                       = var.config_DB_NAME
    DB_USER                                       = var.config_DB_USER
    CLUSTER_URL                                   = var.config_CLUSTER_URL
    COOKIE_NNCE                                   = var.config_COOKIE_NNCE
    COOKIE_PRIMSCOOKIE                            = var.config_COOKIE_PRIMSCOOKIE
    COOKIE_PKEY                                   = var.config_COOKIE_PKEY
    REDIS_HOST                                    = var.config_REDIS_HOST
    REDIS_PORT                                    = var.config_REDIS_PORT
    REDIS_TIMEOUT_GET_APISERVER_STATUS            = var.config_REDIS_TIMEOUT_GET_APISERVER_STATUS
    LOCALHOST_PROXY_DASHBOARD_URL                 = var.config_LOCALHOST_PROXY_DASHBOARD_URL
    LOCALHOST_PROXY_IDP_URL                       = var.config_LOCALHOST_PROXY_IDP_URL
    LOCALHOST_PROXY_AUTHORIZATION_URL             = var.config_LOCALHOST_PROXY_AUTHORIZATION_URL
    AUTHZ_POD_PORT                                = var.config_AUTHZ_POD_PORT
    DASHBOARD_POD_PORT                            = var.config_DASHBOARD_POD_PORT
    IDP_POD_PORT                                  = var.config_IDP_POD_PORT
    PROXY_POD_PORT                                = var.config_PROXY_POD_PORT
    DEFAULT_CONTENT_SECURITY_POLICY_API_DASHBOARD = var.config_DEFAULT_CONTENT_SECURITY_POLICY
    MAX_SHUTDOWN                                  = var.config_MAX_SHUTDOWN
    MAX_REDEPLOY                                  = var.config_MAX_REDEPLOY
    SEND_EMAIL_SERVER                             = var.config_SEND_EMAIL_SERVER
    COST_LIMIT_ENABLED                            = var.config_COST_LIMIT_ENABLED
    COST_LIMIT_MAXCOST                            = var.config_COST_LIMIT_MAXCOST
    COST_LIMIT_OBJECTCOST                         = var.config_COST_LIMIT_OBJECTCOST
    COST_LIMIT_SCALARCOST                         = var.config_COST_LIMIT_SCALARCOST
    COST_LIMIT_DEPTHCOSTFACTOR                    = var.config_COST_LIMIT_DEPTHCOSTFACTOR
    COST_LIMIT_IGNOREINTROSPECTION                = var.config_COST_LIMIT_IGNOREINTROSPECTION
    COST_LIMIT_N                                  = var.config_COST_LIMIT_N
    MAX_ALIASES_ENABLED                           = var.config_MAX_ALIASES_ENABLED
    MAX_ALIASES_N                                 = var.config_MAX_ALIASES_N
    MAX_DIRECTIVES_N                              = var.config_MAX_DIRECTIVES_N
    MAX_DEPTH_N                                   = var.config_MAX_DEPTH_N
    MAX_TOKENS_N                                  = var.config_MAX_TOKENS_N
    PRIM_SERVER_HTTP_CORS_ORIGIN_IDP              = var.config_PRIM_SERVER_HTTP_CORS_ORIGIN_IDP
    MAX_CHARACTERS_N                              = var.config_MAX_CHARACTERS_N
    PROCESS_TIMEOUT_N                             = var.config_PROCESS_TIMEOUT_N
    UI_PROCESS_TIMEOUT_N                          = var.config_UI_PROCESS_TIMEOUT_N
    DB_RECORDS_BATCH_SIZE                         = var.config_DB_RECORDS_BATCH_SIZE
    QUERY_COMPLEXITY_LIMIT                        = var.config_QUERY_COMPLEXITY_LIMIT
    DEFAULT_CONTENT_SECURITY_POLICY               = var.config_DEFAULT_CONTENT_SECURITY_POLICY
    UI_URL                                        = var.config_UI_URL
    OIDC_URL                                      = var.config_OIDC_URL
    OIDC_CLIENT_ID                                = var.config_OIDC_CLIENT_ID
  }
...
resource "kubernetes_config_map" "dataloader_ui_config" {
  ...
  data = {
    NODE_ENV                           = var.dl_ui_config_NODE_ENV
    PORT                               = var.dl_ui_config_PORT
    REACT_APP_DATALOADER_URL           = var.dl_ui_config_REACT_APP_DATALOADER_URL
    REACT_APP_UI_URL_3EDGES            = var.dl_ui_config_REACT_APP_UI_URL_3EDGES
    REACT_APP_ACCESS_TOKEN_COOKIE_NAME = var.dl_ui_config_REACT_APP_ACCESS_TOKEN_COOKIE_NAME
    REACT_APP_NONCE_COOKIE_NAME        = var.dl_ui_config_REACT_APP_NONCE_COOKIE_NAME
    REACT_APP_PKEY_COOKIE_NAME         = var.dl_ui_config_REACT_APP_PKEY_COOKIE_NAME
    REACT_APP_ID_TOKEN_COOKIE_NAME     = var.dl_ui_config_REACT_APP_ID_TOKEN_COOKIE_NAME
    REACT_APP_OIDC_CLIENT_ID           = var.dl_ui_config_REACT_APP_OIDC_CLIENT_ID
    REACT_APP_OIDC_URL                 = var.dl_ui_config_REACT_APP_OIDC_URL
    REACT_APP_JWKS_URI                 = var.dl_ui_config_REACT_APP_JWKS_URI
    REACT_APP_DOCUMENTATION_URL        = var.dl_ui_config_REACT_APP_DOCUMENTATION_URL
  }
...
resource "kubernetes_config_map" "dataloader_config" {
  ...
  data = {
    NODE_ENV                                = var.dl_config_NODE_ENV
    CORS_ORIGIN                             = var.dl_config_CORS_ORIGIN
    PORT                                    = var.dl_config_PORT
    NEO4J_POOL_SIZE                         = var.dl_config_NEO4J_POOL_SIZE
    NEO4J_CONNECTION_ACQUISITION_TIMEOUT_MS = var.dl_config_NEO4J_CONNECTION_ACQUISITION_TIMEOUT_MS
    NEO4J_MAX_CONNECTION_LIFETIME           = var.dl_config_NEO4J_MAX_CONNECTION_LIFETIME
    NEO4J_CONNECTION_TIMEOUT                = var.dl_config_NEO4J_CONNECTION_TIMEOUT
    dbName                                  = var.dl_config_dbName
    dbUser                                  = var.dl_config_dbUser
    dbHost                                  = var.dl_config_dbHost
    OIDC_URL                                = var.dl_config_OIDC_URL
    OIDC_CLIENT_ID                          = var.dl_config_OIDC_CLIENT_ID
    CONFIGURATION_URL                       = var.dl_config_CONFIGURATION_URL
  }
